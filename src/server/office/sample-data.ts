  ...
  devices: [
    {
      ...
      engine: "openclaw",
      nativeDashboardUrl: "http://127.0.0.1:18789/",
      status: "online",
    ...
    },
    {
      ...
      type: "docker_openclaw",
      engine: "openclaw",
      nativeDashboardUrl: "http://127.0.0.1:18790/",
      status: "busy",
      resourcePool: "docker-core",
    ...
    },
    {
      ...
      type: "docker_openclaw",
      engine: "openclaw",
      nativeDashboardUrl: "http://127.0.0.1:18791/",
      status: "busy",
    ...
    },
    {
      ...
      name: "Hermes Agent Runner-01",
      type: "docker_hermes_agent",
      engine: "hermes-agent",
      nativeDashboardUrl: "http://127.0.0.1:19119/",
      status: "unhealthy",
      resourcePool: "docker-backoffice",
      currentSessionStatus: "failed",
      currentTaskId: "75555555-5555-4755-8555-555555555555",
      healthSummary: "最近一次 Hermes Agent 供应商门户会话超时，需要人工复核",
    },
  ],
  approvals: [
    {
