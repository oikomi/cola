...
function gitLabWeeklyReportPromptLines(
  ...
  return [
    ...
    "Keep the final report at or below 12,000 Chinese characters. Use headings and compact bullet lists only; do not use Markdown tables, HTML, Mermaid, or long raw commit inventories because the result will be converted into Feishu document blocks.",
    ...
    "Under 成员工作情况, include every contributor exactly once. Use one compact bullet per contributor, normally no more than 160 Chinese characters, covering project scope, evidence-based deliverable or evidence gap, and only material risk/follow-up. Do not repeat generic evidence-gap wording for every person.",
