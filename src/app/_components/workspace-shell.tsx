    ...
    <div className="grid gap-3">
      {Array.from({ length: 3 }).map((_, index) => (
        <div
          ...
          className="rounded-[var(--radius-shell)] border border-slate-200/80 bg-[linear-gradient(180deg,rgba(255,255,255,0.94),rgba(248,250,252,0.9))] p-5 shadow-[0_18px_34px_rgba(15,23,42,0.045)]"
        >
            ...
            <div className="grid gap-3 2xl:hidden">
              {rows.map((workspace) => (
                ...
                >
                  ...
                  <div className="mt-4 grid gap-3 rounded-[var(--radius-card)] bg-slate-50/90 px-3 py-3 text-[13px] leading-5 text-slate-600">
                    <div className="flex items-start justify-between gap-3">
                    ...
                    >
                      <TableCell className="px-4 py-4 align-middle">
                        <div className="flex items-center gap-3">
                          <span className="flex size-10 shrink-0 items-center justify-center rounded-[var(--radius-card)] border border-slate-200/85 bg-white/94 text-slate-600 shadow-[0_10px_18px_rgba(15,23,42,0.04)]">
                            <MonitorSmartphoneIcon className="size-4" />
                          </span>
                          <div className="min-w-0">
                            <p className="truncate text-[15px] font-semibold tracking-normal text-slate-950">
